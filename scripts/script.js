...
function KeyListener(event) {
    ...
    document.getElementById("Event__Key_Container").innerHTML = event.key == " " ? event.code : event.key;
    document.getElementById("Event__Location_Container").innerHTML = Object.values(keyLocations)[event.location];

}        

function codeName(code){
    for (var [key, value] of Object.entries(keyCodesValues)) {
        if(key == code){
            return value
        } 
    }
...
function copyToClipboard(element) {
  ...
  function handlerAlert(){
    console.log("click")
    var elem = document.getElementById("alert-text__done")
